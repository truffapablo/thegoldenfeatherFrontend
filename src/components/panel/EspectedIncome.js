...
export const EspectedIncome = () => {
  ...
  const getIncome = (array) => {
    ...
    array.map(reservations => {
        reservations.map(reservationType => {
            if(reservationType.status !== reservationStatus.reservationCancelled){
  ...
  return (
    ...
    <div className="card-body">
        <h5 className="card-title">Ingresos estimados</h5>

        <div className="d-flex align-items-center">
        <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
            <i className={`fas fa-arrow-trend-up fa-3x`}></i>
        </div>
        <div className="ps-3">
