  ...
  return (
    ...
    <div className="card-body">
        ...
        <div className="ps-3">
            ...
            <ul>
              <li><span className="text-info small pt-1 fw-bold">Confirmadas</span> <span className="text-muted small pt-2 ps-1">{confirmed.length}</span></li>
              <li><span className="text-warning small pt-1 fw-bold">Pendientes</span> <span className="text-muted small pt-2 ps-1">{pending.length}</span></li>
              <li><span className="text-danger small pt-1 fw-bold">Canceladas</span> <span className="text-muted small pt-2 ps-1">{canceled.length}</span></li>
              <li><span className="text-success small pt-1 fw-bold">Completadas</span> <span className="text-muted small pt-2 ps-1">{completed.length}</span></li>
            </ul>
